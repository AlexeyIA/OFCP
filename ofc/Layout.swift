...
class Layout : UIViewController  {
    ...
    func createStartButton (button: UIButton) {
        ...
        let i = cardPlacesLay[4].frame
        
        button.frame = CGRect(origin: i.origin, size: CGSize(width: i.width * 2 , height: i.height))
        
        button.frame.origin.x += (i.width + 2)
        ...
        button.setTitle("NEW ROUND", for: UIControlState.normal)
    ...
    func createCardLay (Rect: CGRect) -> UILabel {
